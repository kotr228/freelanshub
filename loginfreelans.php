...
<div class="wrapper">
  <div class="content">
    <div class="header">
      <h3 class="sign-in">Увійти</h3>
      <div class="container">
        <div class="button" role="button" tabindex="0" onclick="window.location.href='registrfreelans.php'">
            Зареєстуватися
        </div>
    </div>
    </div>
    
    <form action="delat_zakazy.php" method="POST">
        <!--Поле для ПОЧТИ-->
        <div>
